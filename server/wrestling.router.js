...
router.get("/wrestling/data/eventupdate", data.eventUpdateGet);
router.post("/wrestling/data/eventupdate", data.eventUpdateSave);
router.delete("/wrestling/data/eventupdate", data.eventUpdateDelete);
...
router.get("/wrestling/api/getallwrestlers", api.getAllWrestlers);
